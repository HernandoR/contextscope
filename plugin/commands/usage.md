...
```bash
npx @hernandor/contextscope ui --no-open > /tmp/contextscope.log 2>&1 &
sleep 2
...
If `npx @hernandor/contextscope` is not installed, tell the user to install with `npm install -g @hernandor/contextscope` and try again.
